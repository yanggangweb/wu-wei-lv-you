<template type="text/html" lang="jade">
    f7-page(:class="name")
        f7-navbar(sliding="")
            ...
            f7-nav-center
                span {{all.merchantName}}
            f7-nav-right
                f7-link(icon="i-iconziti17",open-panel="right")

        picker.techan-dishilist-shopping-card(ref="shopCard")
            .title
                span
...
<style lang="less" rel="stylesheet/less">
    ...
    .techan-dishilist-shopping-card{
        color: #4a4a4a;
        padding-top:@page-edge;
